...
namespace DraxTechnology
{
    ...
    public enum enmEventType
    {
        ...
        ID2netMessageDeliverFailure = 400,
        WalkTestSoundersStart = 401,
        WalkTestNoSoundersStart = 402,
        WalkTestAutoReset = 403,
        WalkTestEnd = 404,
        MainsBrownOut = 405,
        PSUModuleFault = 406,
        AuxSupplyFault = 407,
        MemoryLockOpen = 408,
        DisableLocalInputs = 409,
        EnableLocalInputs = 410,
        PCEvent1 = 411,
        PCEvent2 = 412,
        PCEvent3 = 413,
        PCEvent4 = 414,
        ...
        PCEvent7 = 417,
        PCEvent8 = 418,
        BatteryWiringFault = 419,
        PerformanceCardReadFault = 420,
        AuxillarySupplyDisconnected = 421,
        LEDCardMissingFFault = 422,
        NetworkPanelMissing = 423,
        MaximumLoopsExceeded = 424,
        LEDCardAddedFault = 425,
        RemoteLinkNoReply = 426,
        PanelStatusMismatch = 427,
        ConfigStatusMismatch = 428,
        GeneralNonDeviceFaultatRemotePanel = 429,
        NewAuxillarySUpply = 430,
        AllClearMessage = 431,
        StartSystemTest = 432,
        StopSystemTest = 433,
        SystemIOCardMissingFault = 434,
        SystemIOCardAddedFault = 435,
        SystemIOCardVersionMismatch = 436,
        SystemIOCardRestart = 437,
        SystemIOCardCommsFaul = 438,
        FATFBFCommsFailureFault = 439,
        FATFBFMissingFault = 440,
        RemoteFireOutputTestEnd= 441,
        SSTDeviceTestStart = 442,
        SSTDeviceTestEnd = 443,
        ActivateRemoteFireOutput = 444,
        ActivateSSTDevices = 445,
        SuppressInternalBuzzer = 446,
        EnableInternalBuzzer = 447
    ...
    public enum enmNotEventType
    {
        ...
        // Sub-400 gaps filled from 099-048 section 3.5.2 pages 69-73
        // (added 2026-07-24; reserved / not-implemented / device-event
        // ranges deliberately omitted).
        AllViewSensorsReplacedOnLoop = 133,
        PasscodeWarning = 134,
        ControlMatrixEntryCreated = 141,
        ControlMatrixEntryDeleted = 142,
        EditedChangesCancelled = 144,
        TestActivationSounderRelayCircuit = 145,
        NetworkStationNameChanged = 151,
        NetworkConfigurationChanged = 152,
        RemoteInitiatedTestZone = 158,
        InvestigationDelayExtendedCircuit = 164,
        PanelMainCoverRemoved = 174,
        PanelMainCoverReplaced = 175,
        RemoteFireOutputDeactivated = 177,
        FireControlDevicesDisabled = 179,
        FireControlDevicesEnabled = 180,
        SSTDevicesDisabled = 187,
        SSTDevicesEnabled = 188,
        PanelExpansionCoverRemoved = 189,
        PanelExpansionCoverReplaced = 190,
        RepeaterCommsFail = 201,
        TestDeactivationSounderRelayCircuit = 202,
        AllSoundersTestedOnLoop = 215,
        BackupFireLineActivated = 235,
        SectorAssignmentError = 236,
        PanelAskedToSuspendUnsolicited = 246,
        PanelAskedToResumeUnsolicited = 247,
        MainCPUWatchdogOperated = 296,
        CPUEPROMChecksumError = 297,
        CPUE2PROMMemoryWriteError = 298,
        CPUFlashMemoryChecksumError = 299,
        PrinterFault = 300,
        CPUFlashMemoryWriteError = 301,
        CPUDisplayHardwareFault = 303,
        BaseboardExpansionHardwareFault = 304,
        CPUWatchdogTimerFault = 305,
        CPUWatchdogNotEnabled = 320,
        ClockSetToAfterAD2099 = 321,
        CPUClockMonitorFailure = 322,
        CPUIllegalInstruction = 323,
        PSUFaultCrowbarActive = 326,
        ConfigurationNeedsExpansionCard = 327,
        ConfigurationNeedsRS485Card = 328,
        ConfigurationNeedsRS232Card = 329,
        CommsCardDisplaced = 330,
        PoweredOffDueToLowBattery = 331,
        ExternalPSUDualTXPathFault = 333,
        ExternalPSULowSystemVoltage = 334,
        ELIBCardMissingOrFault = 335,
        ELIBFlashMemoryWriteFail = 339,
        ELIBDataDownloadFailed = 343,
        MainCPUWatchdogOperatedCOP = 349,
        IncompatibleLIBCardInstalled = 351,
        IncompatibleLoopDeviceAndLIB = 366,
        PowerSupplySecondaryBackupFault = 369,
        IncompatiblePanelNetworkZones = 370,
        ID2netPrimaryCPUFault = 371,
        ID2netSecondaryCPUFault = 372,
        ID2netPartialOpenShortCircuitFault = 373,
        ID2netPhaseReversalFault = 374,
        ID2netChannelInversionFault = 375,
        IncompatibleBaudRateCombination = 376,
        SounderCircuitsCPUFault = 377,
        ExtinguishingSystemExternalFault = 378,
        ExtinguishingSystemTXPathFault = 379,
        TooManyCLIPAddresses = 380,
        OPALAutoConfigIncomplete = 381,
        SensorAtAddressOutOfRange = 382,
        ModuleAtAddressOutOfRange = 386,

        // 400+ block from 099-048 section 3.5.2 pages 74 (protocol version
        // 0012 generation; the Inspire emits these). Names match the
        // enmEventType copy added 2026-07-24.
        ID2netMessageDeliverFailure = 400,
        WalkTestSoundersStart = 401,
        WalkTestNoSoundersStart = 402,
        WalkTestAutoReset = 403,
    ...
    {
        NOTFire = 0,
        NOTInputActivated1 = 1,
        NOTPreAlarm = 2,
        NOTInputActivated2 = 3,
        NOTIsolate = 4,
        NOTInputActivated3 = 5,
        NOTTestModeFire = 6,
        NOTInputActivated4 = 7,
        NOTFault = 8,
        NOTOutputActivate = 9,
    ...
    public partial class DraxService : ServiceBase
    {
        ...
        private void StartTaktisConnections(List<TaktisConnectionSettings> conns)
        {
            ...
            if (cap < 0)
            {
                // TEMPORARY TEST FUDGE (2026-08-18): capped at 2 so the
                // two-panel rig runs while James's licence key doesn't exist
                // yet. REVERT TO 1 BEFORE ANY RELEASE — an absent key must
        ...
        private void startpipeserver()
        {
            try
            {
                ...
                // .NET Core dropped the PipeSecurity-aware constructor; the equivalent
