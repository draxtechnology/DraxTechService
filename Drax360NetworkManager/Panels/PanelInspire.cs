...
namespace DraxTechnology.Panels
{
    internal class PanelInspire : AbstractPanel
    {
        ...
        private readonly HashSet<(int p2, int p3, int p4, int p1)> _activeIsolations = new();
        ...
        public override void Parse(byte[] buffer)
        {
            ...
            while (true)
            {
                ...
                if (cmd == "IE")
                {
                    ...
                    this.NotifyClient(DateTime.Now + ": " + "Event " + eventcode + " Zone " + zone + " Address " + giAddressNumber);
                    this.NotifyClient("Sensor: " + sensor + " Loop: " + loop + " Panel: " + panel + " ModuleOffset: " + moduleoffset + " ModuleOffsetMode: " + moduleoffsetmode);
        ...
        public virtual void send_message(ActionType action, string passedvalues)
        {
            ...
            // Must run before the moduleoffset remap below, which keys on node.
            if (this.Offset > 0 && node > this.Offset)
                node -= this.Offset;
